...
echo
echo "Downloading cli: https://github.com/jbclabs/go-apl/releases/download/${APL_CMD_RELEASE}/${APL_FILE}"
wget -q https://github.com/jbclabs/go-apl/releases/download/${APL_CMD_RELEASE}/${APL_FILE}
tar zxf ${APL_FILE}
...
#artifact_name: https://github.com/jbclabs/acme-air/archive/${TRAVIS_TAG}.zip
artifact_name: https://github.com/jbclabs/acme-air/archive/${TRAVIS_COMMIT}.zip
